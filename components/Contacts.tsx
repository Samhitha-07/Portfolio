  ...
  return (
    <section id="contact">
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 text-black/85 inline">
        Connect With Me <span className="text-6xl sm:text-7xl md:text-8xl text-orange-400">.</span>
      </h2>
        ...
        <div className="grid grid-cols-1 mt-10 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm sm:text-[1rem]">Your Name</label>
                <input
                  type="text"
                  id="name"
                  name="name"
                  ...
                  className="w-full p-3 mt-2 text-base sm:text-[1.1rem] bg-orange-50 text-orange-400 rounded-lg focus:outline-none"
              ...
              <div>
                <label htmlFor="email" className="block text-sm sm:text-[1rem]">Your Email</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm sm:text-[1rem]">Your Message</label>
                <textarea
                  id="message"
                  name="message"
