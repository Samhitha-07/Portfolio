    ...
    <div className="fixed top-0 left-0 w-full z-50 backdrop-blur-lg bg-white">
      <nav className="container mx-auto px-4 py-8 flex justify-between items-center ">
        ...
        <div className="hidden sm:flex space-x-8">
          ...
          {/* <a href="/resume/Samhitha_Resume_latest.pdf" download={"Samhitha_Resume.pdf"} className="text-[1.3rem] font-semibold text-black hover:text-orange-400">Resume</a>*/}
          <a
          ...
          {/*<a href="#Blog" className="text-[1.3rem] font-semibold text-black hover:text-orange-400">Blogs</a>*/}
      ...
      <div className="sm:hidden px-4 pb-4 flex flex-col space-y-4  backdrop-blur-lg">
        ...
        {/*<a href="#Blog" className="text-xl font-semibold text-black hover:text-orange-400 pl-2">Blogs</a>*/}
